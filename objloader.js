...
const texture = textureLoader.load('3D_Model_texture.jpg'); // Replace with your texture file path

// Instantiate OBJLoader
const loader = new OBJLoader();

// Define the model to load
const objToRender = '3D_Model_simplified_3d_mesh_updated.obj'; // Path to your OBJ file
